...
{
public:
  static map<string, vector<ScAddr>> intersectReplacements(
      map<string, vector<ScAddr>> const & first,
      map<string, vector<ScAddr>> const & second);
  static map<string, vector<ScAddr>> uniteReplacements(
      map<string, vector<ScAddr>> const & first,
      map<string, vector<ScAddr>> const & second);
