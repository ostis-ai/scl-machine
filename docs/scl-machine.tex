...
\begin{scnrelfromset}{декомпозиция}
    ...
    \begin{scnindent}
        ...
        \end{scnindent}
        \scnhaselement{generateOnlyFirst}
        \begin{scnindent}
        ...
        \end{scnindent}
        \scnhaselement{generateSolutionTree}
        \begin{scnindent}
        ...
        \end{scnindent}
    \end{scnindent}
    \scnitem{Конфиг параметров логического вывода}
    \begin{scnindent}
        \scnidtf{InferenceParamsConfig}
        \scntext{примечание}{Такой конфиг передаётся при каждой использовании логического вывода с уже созданным \scnkeyword{менеджером логического вывода}.}
        \scnhaselement{formulasSet}
        \scnhaselement{arguments}
        \scnhaselement{inputStructures}
        \scnhaselement{outputStructure}
        \scnhaselement{targetStructure}
    \end{scnindent}
\end{scnrelfromset}
