...
\scnhaselement{
	\begin{adjustwidth}{\calctab}{0em}
		...
		\begin{tabular}{lllllll}
			...
			\textless{} & \_n1 & ,\textless{} & n1 & , & n2 & \textgreater{}\textgreater{},  \\
			\textless{} & \_e2 & ,\textless{} & e3 & , & e4 & \textgreater{}\textgreater{},  \\
			\textless{} & \_n2 & ,\textless{} & n3 & , & n3 & \textgreater{}\textgreater{}\}
		\end{tabular}
	\end{adjustwidth}
}
\begin{scnindent}
	\scnrelfrom{комментарий}{Если в формулу example\_formula на место переменных \_e1, \_n1, \_e2, \_n2 подставить первую колонку области прибытия подстановок e1, n1, e3, n3 соответственно, то атомарная логическая формула example\_formula станет истинной. То же самое можно сказать и со значениями второй колонки.}
